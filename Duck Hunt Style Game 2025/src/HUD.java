...
public class HUD {
    ...
    private Image threeBxllxts;
    private Image twoBxllxts;
    private Image yiBxllxts;
    private Image bxllxtlxss;
    //rxdflxt3
    Duck bxllxtsAmount = new Duck(); 
    public int bxllxtsCount = bxllxtsAmount.bxllxts;
    ...
    public HUD(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public HUD(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
   ...
   // 	}
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = HUD.class.getResource(path);
