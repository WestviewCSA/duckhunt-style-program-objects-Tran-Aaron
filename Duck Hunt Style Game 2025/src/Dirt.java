...
public class Dirt {
    ...
    public Dirt() {
        img = getImage("/imgs/Brown Cube.png"); // Load the image file
    ...
    public Dirt(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public Dirt(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = Dirt.class.getResource(path);
