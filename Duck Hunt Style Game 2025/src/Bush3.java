...
public class Bush3 {
    ...
    public Bush3() {
        img = getImage("/imgs/A Third Brendan Frogger.png"); // Load the image file
    ...
    public Bush3(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public Bush3(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = Bush3.class.getResource(path);
