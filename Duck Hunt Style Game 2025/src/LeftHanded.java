...
public class LeftHanded {
    ...
    public LeftHanded() {
        img = getImage("/imgs/Left Hand.png"); // Load the image file
    ...
    public LeftHanded(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public LeftHanded(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = LeftHanded.class.getResource(path);
