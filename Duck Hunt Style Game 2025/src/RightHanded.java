...
public class RightHanded {
    ...
    public RightHanded() {
        img = getImage("/imgs/Right Hand.png"); // Load the image file
    ...
    public RightHanded(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public RightHanded(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
  ...
  x = rightHandRise.xVal;
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = RightHanded.class.getResource(path);
